...
BUSINESS_VALUE = Gauge(
    ...
    ["service", "metric", "tenant_id"]
)

ACTIVE_USERS = Gauge(
    "business_active_users",
    "Number of active users",
    ["service", "period", "tenant_id"]
)

FEATURE_USAGE = Counter(
    "business_feature_usage_total",
    "Feature usage count",
    ["service", "feature", "tenant_id"]
)
...
class BusinessMetrics:
    ...
    def track_active_user(
        ...
        ACTIVE_USERS.labels(
            ...
            period=period,
            tenant_id=tenant_id
        ).set(len(self._active_users[key]))
...
class FunnelTracker:
    ...
    def enter(self, user_id: str, stage: Optional[str] = None, tenant_id: str = "default"):
    ...
    def drop(self, user_id: str, reason: Optional[str] = None, tenant_id: str = "default"):
    ...
    def get_conversion_rates(self) -> Dict[str, float]:
        ...
        for user_id, stage_index in self._user_stages.items():
