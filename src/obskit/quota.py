...
class TenantUsage:
    ...
    last_exceeded: Optional[datetime] = None
...
class QuotaTracker:
    ...
    def __init__(
        ...
        on_exceeded: Optional[Callable[[str, str, TenantUsage], None]] = None,
        on_warning: Optional[Callable[[str, str, TenantUsage], None]] = None,
    ):
    ...
    def get_report(self, tenant_id: str) -> QuotaReport:
        ...
        with self._lock:
            ...
            if tenant_id in self._usage:
                for resource, usage in self._usage[tenant_id].items():
                    self._maybe_reset_period(usage)
                    usages.append(usage)
