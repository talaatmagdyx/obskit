...
class BatchContext:
    ...
    def record_failure(self, count: int = 1, error: Optional[str] = None, **metadata):
        """
    ...
    def record_skip(self, count: int = 1, reason: Optional[str] = None):
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_success_rate": (
                ...
                if self._total_items > 0 else 1.0
            )
        }
