...
class ObservableError(Exception):
    ...
    def to_response(
        ...
        return ErrorResponse(
            ...
            stack_trace=traceback.format_exception(type(self), self, self.__traceback__) if include_stack_trace else None,
        )
...
class ValidationError(ObservableError):
    ...
    def __init__(self, message: str, field: Optional[str] = None, **kwargs):
        ...
        if field:
            details["field"] = field
        super().__init__(message, code="VALIDATION_ERROR", details=details, http_status=400, **kwargs)
...
class RateLimitError(ObservableError):
    ...
    def __init__(self, message: str = "Rate limit exceeded", retry_after: Optional[int] = None, **kwargs):
        ...
        super().__init__(message, code="RATE_LIMIT_EXCEEDED", details=details, http_status=429, **kwargs)
