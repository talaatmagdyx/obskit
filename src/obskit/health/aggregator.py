...
DEPENDENCY_LATENCY = Gauge(
    "dependency_health_latency_seconds",
    "Dependency health check latency",
    ["dependency"]
)

DEPENDENCY_CHECK_TOTAL = Counter(
    "dependency_health_checks_total",
...
class DependencyHealthAggregator:
    ...
    def __init__(
        ...
        self._last_aggregated: Optional[AggregatedHealth] = None
    ...
    async def check_all(self, use_cache: bool = True) -> AggregatedHealth:
        ...
        tasks = {
            name: self.check(name, use_cache)
    ...
    def get_cached_health(self) -> Optional[AggregatedHealth]:
