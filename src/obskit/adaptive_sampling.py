...
SAMPLING_DECISIONS = Counter(
    "adaptive_sampling_decisions_total",
...
class AdaptiveSampler:
    ...
    def should_sample(
        ...
        self._record_decision(
            SamplingDecision.SAMPLE if should_sample else SamplingDecision.DROP,
            reason
        )
