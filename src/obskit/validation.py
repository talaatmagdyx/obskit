...
class ValidationTracker:
    ...
    def validate(
        self,
        data: Any,
        validator: Optional[Callable[[Any], Union[bool, Dict, List]]] = None,
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (
                ...
                if self._total_validations > 0 else 1.0
            ),
