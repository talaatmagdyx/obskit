...
DEPLOYMENT_TRAFFIC = Gauge(
    "deployment_traffic_percent",
    "Traffic percentage to deployment",
    ["version"]
)
...
class DeploymentTracker:
    ...
    def get_deployment(self, version: str) -> Optional[Deployment]:
...
_tracker: Optional[DeploymentTracker] = None
