...
ADAPTIVE_RETRY_ERROR_RATE = Gauge(
...
ADAPTIVE_RETRY_BACKPRESSURE = Gauge(
    "adaptive_retry_backpressure_multiplier",
    "Current backpressure multiplier",
    ["name"]
)

ADAPTIVE_RETRY_CONCURRENCY = Gauge(
    "adaptive_retry_concurrent_requests",
...
class AdaptiveRetry:
    ...
    async def execute(
        ...
        **kwargs
        ...
        async with self._semaphore:
            ...
            ADAPTIVE_RETRY_CONCURRENCY.labels(name=self.name).set(
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        error_rate = (
            1 - (sum(self._results) / len(self._results))
