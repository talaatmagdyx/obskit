...
class CircuitBreaker:
    ...
    def __init__(
        ...
        # threading.Lock protects state shared between sync and async callers.
        # Operations inside the lock are all sub-microsecond (counter increments
        # and flag assignments), so briefly blocking the event loop is safe.
