...
class ObskitTestCase(unittest.TestCase):
    ...
    # Test context
    _obskit_context: Optional[ObskitTestContext] = None
    ...
    def assertNoMetrics(self, operation: Optional[str] = None):
    ...
    def getMetricCount(self, operation: str, status: Optional[str] = None) -> int:
