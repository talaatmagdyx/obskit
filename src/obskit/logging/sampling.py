...
class SamplingRule:
    ...
    dedupe_key: Optional[str] = None  # Key for deduplication
...
class SampledLogger:
    ...
    def _cleanup_recent(self):
        ...
        keys_to_remove = [
            k for k, v in self._recent_logs.items()
            if v < cutoff
        ]
    ...
    def _log(self, level: str, event: str, **kwargs):
        ...
        should_log, reason = self._should_log(
            level, event, duration, important, **kwargs
        )
