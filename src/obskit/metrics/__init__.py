...
__all__ = [
    ...
    # ==========================================================================
    # Get {"trace_id": ..., "span_id": ...} for the active span
    "get_trace_exemplar",
    # Observe a prometheus_client metric with auto-injected trace exemplar
    "observe_with_exemplar",
    # True when both OTel and prometheus-client are installed
    "is_exemplar_available",
]
