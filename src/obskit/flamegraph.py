...
PROFILE_SAMPLES = Counter(
    "flamegraph_profile_samples_total",
    "Total profile samples collected",
    ["operation"]
)

PROFILE_ACTIVE = Gauge(
    "flamegraph_profile_active",
...
class ProfileResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "top_functions": [
                {"name": f[0], "time_ms": f[1], "calls": f[2]}
...
class FlameGraphProfiler:
    ...
    def get_profile(self, operation: str) -> Optional[ProfileResult]:
    ...
    def generate_flamegraph_data(self, operation: str) -> Optional[FlameGraphData]:
        """
    ...
    def export_collapsed(self, operation: str) -> str:
        ...
        lines = []
        for name, time_ms, calls in profile.top_functions:
...
def profile_function(
    ...
    profiler: Optional[FlameGraphProfiler] = None,
):
    """
...
_profiler: Optional[FlameGraphProfiler] = None
