...
class TestOTLPMetricsExporter:
    ...
    def test_init_with_custom_params(
        self, mock_otel, mock_provider, mock_reader, mock_exporter, mock_resource
    ):
    ...
    @patch("obskit.metrics.otlp.MeterProvider")
    @patch("obskit.metrics.otlp.otel_metrics")
    def test_force_flush_not_started(
        self, mock_otel, mock_provider, mock_reader, mock_exporter, mock_resource
    ):
    ...
    @patch("obskit.metrics.otlp.MeterProvider")
    @patch("obskit.metrics.otlp.otel_metrics")
    def test_get_meter_not_started(
        self, mock_otel, mock_provider, mock_reader, mock_exporter, mock_resource
    ):
    ...
    def test_http_exporter(
        self, mock_otel, mock_provider, mock_reader, mock_http_exporter, mock_resource
    ):
