...
class TestSelfMetricsFunctions:
    ...
    def test_get_self_metrics_singleton(self) -> None:
        ...
        metrics1 = self_metrics_module.get_self_metrics()
        metrics2 = self_metrics_module.get_self_metrics()
    ...
    def test_record_dropped_metric(self) -> None:
        ...
        self_metrics_module.reset_self_metrics()
        self_metrics_module.record_dropped_metric("test_operation", "queue_full")
        # Should not raise
    ...
    def test_record_error(self) -> None:
        ...
        self_metrics_module.reset_self_metrics()
        self_metrics_module.record_error("test_component", "TestError")
        # Should not raise
    ...
    def test_update_queue_metrics(self) -> None:
        ...
        self_metrics_module.reset_self_metrics()
        self_metrics_module.update_queue_metrics(depth=100, capacity=10000)
        # Should not raise
