"""Tests for obskit.integrations.queue.kafka module."""
...
class TestInstrumentKafka:
    ...
    @patch("obskit.integrations.queue.kafka.logger")
...
class TestInstrumentKafkaImportError:
    ...
    def test_import_error_handled(self):
        ...
        try:
            ...
            import obskit.integrations.queue.kafka as qk_mod
