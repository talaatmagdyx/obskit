"""
Tests for obskit.integrations.queue.dlq module.
...
class TestDLQRegistryHelpers:
    def setup_method(self):
        ...
        import obskit.integrations.queue.dlq as module
...
class TestGetDlqTrackerDoubleLock:
    ...
    def test_inner_lock_already_set(self):
        import obskit.integrations.queue.dlq as dlq_mod
        from obskit.integrations.queue.dlq import DLQTracker
