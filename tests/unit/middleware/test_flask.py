...
class TestObskitFlaskMiddleware:
    ...
    def test_init_with_app(self, mock_get_red_metrics):
        ...
        middleware = ObskitFlaskMiddleware(app=mock_app)
    ...
    def test_full_request_cycle(self, mock_get_red_metrics):
        ...
        app = Flask(__name__)
        middleware = ObskitFlaskMiddleware(app, track_tracing=False)
    ...
    def test_correlation_id_from_header(self, mock_get_red_metrics):
        ...
        with app.test_client() as client:
            response = client.get(
                "/test",
                headers={"X-Correlation-ID": "custom-123"}
            )
    ...
    def test_init_app_without_extensions(self, mock_get_red_metrics):
        ...
        class MockApp:
            def before_request(self, f): pass
            def after_request(self, f): pass
            def teardown_request(self, f): pass
    ...
    def test_request_with_tracing(self, mock_extract, mock_inject, mock_get_red_metrics):
        ...
        app = Flask(__name__)
        middleware = ObskitFlaskMiddleware(app, track_tracing=True)
    ...
    def test_request_with_logging(self, mock_logger, mock_get_red_metrics):
        ...
        app = Flask(__name__)
        middleware = ObskitFlaskMiddleware(app, track_tracing=False, track_logging=True)
