...
class TestTenantContext:
    ...
    def test_get_tenant_id_default(self):
        ...
        from obskit.metrics.tenant import get_tenant_id, _tenant_id
    ...
    def test_set_tenant_id(self):
        ...
        from obskit.metrics.tenant import get_tenant_id, set_tenant_id, _tenant_id
...
class TestTenantMetricsContext:
    ...
    def test_context_manager_sets_tenant(self):
        ...
        from obskit.metrics.tenant import tenant_metrics_context, get_tenant_id, _tenant_id
    ...
    def test_context_manager_restores_previous(self):
        ...
        from obskit.metrics.tenant import tenant_metrics_context, get_tenant_id, set_tenant_id, _tenant_id
...
class TestTenantREDMetrics:
    ...
    def test_observe_request(self, mock_red):
        ...
        assert "tenant-123" in call_args.kwargs.get("operation", call_args.args[0] if call_args.args else "")
