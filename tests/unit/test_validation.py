...
class TestValidationResult:
    ...
    def test_init_invalid(self):
        ...
        errors = [
            ValidationError(field="email", error_type="format", message="Invalid")
        ]
    ...
    def test_to_dict(self):
        ...
        result = ValidationResult(
            ...
            schema_name="user_input",
            errors=[
                ValidationError(field="name", error_type="required", message="Required")
            ]
        )
