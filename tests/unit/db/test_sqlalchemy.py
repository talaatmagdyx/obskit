"""Tests for obskit.db.sqlalchemy module."""
...
class TestInstrumentSqlalchemy:
    ...
    def test_instruments_valid_engine(self):
        ...
        with patch.dict(sys.modules, {
            ...
            with patch('obskit.db.sqlalchemy.isinstance', return_value=True):
    ...
    @patch('obskit.db.sqlalchemy.logger')
    def test_invalid_engine_type_logs_warning(self, mock_logger):
        ...
        with patch.dict(sys.modules, {
            ...
            with patch('obskit.db.sqlalchemy.isinstance', return_value=False):
    ...
    def test_handles_import_error(self, mock_logger):
        ...
        try:
            ...
            with patch.dict(sys.modules, {'sqlalchemy': None}):
                # Import fresh
                if 'obskit.db.sqlalchemy' in sys.modules:
                    del sys.modules['obskit.db.sqlalchemy']
...
class TestEventListenerFunctions:
    ...
    def test_after_cursor_execute_tracks_duration(self):
        ...
        with patch.dict(sys.modules, {
            ...
            'sqlalchemy.event': mock_event,
            'sqlalchemy.engine': mock_sqlalchemy.engine,
        }), patch('obskit.db.sqlalchemy.get_golden_signals') as mock_golden:
            mock_signals = MagicMock()
            mock_golden.return_value = mock_signals
            ...
            mock_signals.observe_request.assert_called()
    ...
    def test_on_connect_tracks_saturation(self):
        """Test on_connect tracks connection pool saturation."""
        mock_event = MagicMock()
        mock_engine_class = MagicMock()
        ...
        with patch.dict(sys.modules, {
            ...
            mock_signals.set_saturation.assert_called()
    ...
    def test_after_cursor_execute_without_start_time(self):
        ...
        with patch.dict(sys.modules, {
            ...
            mock_signals.observe_request.assert_not_called()
