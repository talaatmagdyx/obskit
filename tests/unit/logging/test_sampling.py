...
class TestSamplingConfig:
    ...
    def test_always_log_events(self):
        ...
        config = SamplingConfig(
            always_log_events={"startup", "shutdown", "error"}
        )
    ...
    def test_never_log_events(self):
        ...
        config = SamplingConfig(
            never_log_events={"heartbeat", "ping"}
        )
...
class TestSampledLogger:
    ...
    def test_important_flag(self):
        ...
        should_log, reason = logger._should_log(
            "info", "normal_event", important=True
        )
    ...
    def test_slow_operations_always_logged(self):
        ...
        should_log, reason = logger._should_log(
            "info", "slow_event", duration_seconds=2.0
        )
