...
class TestAuditTrail:
    ...
    def test_get_failed_actions(self):
        ...
        audit.record(action=AuditAction.CREATE, actor="user:1", resource="a", result=AuditResult.SUCCESS)
        audit.record(action=AuditAction.DELETE, actor="user:2", resource="b", result=AuditResult.FAILURE)
